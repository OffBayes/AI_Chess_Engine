...
forced = chess.Board(fen='rnb1kbnr/ppppp1pp/5p2/8/4PP1q/8/PPPP2PP/RNBQKBNR w')
...
class TestLegalMovesList:
    ...
    def test_forced(self):
        assert AI.legal_moves_list(checkmate) == ["g1g3"]
